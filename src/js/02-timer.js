...
const refs = {
  startBtn: document.querySelector('[data-start]'), // кнопка запуска
  timerShow: document.querySelector('.timer'), //  блок для показа времени
};
document.querySelector('[data-start]').setAttribute('disabled', '');

let endTime = null;

// добавлять 0 если в числе меньше двух символов
function pad(value) {
